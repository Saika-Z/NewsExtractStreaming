...
sys.path.append('/home/zhaowenqing20/hainiu_crawler')
...
def xpath_config_file():
    ...
    try:
        ...
        #d = DBUtil(_HAINIU_DB)
        r = redis.Redis('nn1.hadoop', 6379, db=12)
        ...
        local_xpath_file_path = '/home/zhaowenqing20/xpath_cache_file/xpath_file' + time_str
        ...
        #上传到HDFS的XPATH配置文件目录
        c.upload("/user/zhaowenqing20/xpath_cache_file/", local_xpath_file_path)
        endtime = time.clock()
